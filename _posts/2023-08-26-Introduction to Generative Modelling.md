...
Generative modeling, promotes understanding of causual relationships between variables involved as we try to understand how their   their values culminate to generate a certain outcome. By mimicking the underlying generative process, this approach allows us to not only replicate outcomes but also unravel the interplay between variables involved and their influences. 
...
## Mixture model and the EM Algorithm
